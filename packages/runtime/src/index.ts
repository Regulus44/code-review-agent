...
export interface AgentHostOptions {
  ...
  /** Selects the model-visible Skill renderer; canonical v2 is the default. */
...
function publicToolResultBudget(
  ...
  return {
    ...
    policy: {
      ...
      ...(policy.retainRecentResultsRatio === undefined ? {} : { retainRecentResultsRatio: policy.retainRecentResultsRatio }),
      ...(policy.microcompactCheckpointMaxChars === undefined ? {} : { microcompactCheckpointMaxChars: policy.microcompactCheckpointMaxChars }),
