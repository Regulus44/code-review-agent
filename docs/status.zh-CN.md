...
- S4 插件：可选本地 bundle runtime，支持受限 manifest、版本 pin、原子安装缓存、enable/disable、reconcile、失败隔离和只读 inventory；插件贡献沿用 Skill/Tool/Prompt registry 及统一权限、workspace、事件管线。
