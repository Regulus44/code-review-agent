...
日期：2026-08-30  
相关方案：[`coding-agent-simple-evaluation-plan.zh-CN.md`](../coding-agent-simple-evaluation-plan.zh-CN.md)、[`workspace-command-guard-plan.zh-CN.md`](../../operations/workspace-command-guard-plan.zh-CN.md)
