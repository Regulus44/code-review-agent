...
按 [Token/Context/Tool 实施基线](../token-context-tool-limits-dsh-claude-code-implementation-plan.zh-CN.md) 将无 capability 的 context fallback 提升到 200K，并统一 Runtime、子 Agent、API 和评测 Runner 的 step 范围；同时把 summary 最终正文上限统一为 8192 字符。
