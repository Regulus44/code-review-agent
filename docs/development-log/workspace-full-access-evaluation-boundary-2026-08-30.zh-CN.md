...
- `docs/coding-agent-simple-evaluation-plan.zh-CN.md`；
- `docs/agent-evaluation-guide.zh-CN.md`；
- `docs/coding-agent-bench-mvp.zh-CN.md`；
- `docs/coding-agent-test-runner-reference.zh-CN.md`；
- `docs/coding-agent-evaluation-environment-grader-dsh-research.zh-CN.md`。
