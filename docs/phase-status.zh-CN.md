...
| Phase 3B：Coding Agent 工具池与工具 Prompt 强化 | in_progress | 3B.0–3B.3 已完成：ToolPromptRegistry、P0 文件/搜索/编辑合同、Bash/Pwsh/Terminal/job 基础语义和 DSH/Claude Code 参考登记；下一步进入 Goal/Session query/read_image/LSP read-only |
