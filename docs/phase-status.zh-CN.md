...
| Phase 3B：Coding Agent 工具池与工具 Prompt 强化 | completed | 3B.0–3B.final 已完成：P0 工具强化、Bash/Pwsh/Terminal/job、durable Goal/Session query、read_image/LSP read-only、扩展 capability gate、Web replay 收口；typecheck、全仓测试、针对性 smoke 和 diff check 通过 |
