...
| Phase 3B：Coding Agent 工具池与工具 Prompt 强化 | in_progress | 3B.0 ToolPromptRegistry、确定性 assembly、内置 prompt catalog 和 DSH/Claude Code 参考登记已完成；下一步进入 P0 工具语义与合同强化 |
