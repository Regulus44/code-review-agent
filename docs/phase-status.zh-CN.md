...
下一切片：补齐各面板 loading/error/empty/reconnect 细节、长任务 terminal/job 输出与失败诊断，推进 Shell 拆分、Workspace/Session 导航和窄屏视觉基线；统一五场景 gate 已落地，继续以 EventStore replay、权限和 workspace 安全边界作为验收基线。
