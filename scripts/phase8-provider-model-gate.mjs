...
async function runWebContractScenario() {
  ...
  try {
    ...
    for (const marker of ["settings-provider-row", "settings-provider-editor", "API token (write-only)", "createCredential", "discoverProvider", "model-command-search", "Provider · Model"]) {
